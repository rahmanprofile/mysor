...
class ImageLabelingFromCamera extends StatefulWidget {
  const ImageLabelingFromCamera({super.key});

  @override
  State<ImageLabelingFromCamera> createState() => _ImageLabelingFromCameraState();
}

class _ImageLabelingFromCameraState extends State<ImageLabelingFromCamera> {
